...
// Constante para o domínio permitido
const ALLOWED_DOMAIN = 'grupohi.com.br';
...
async function registerUser(name, email, password) {
    try {
        ...
        if (!isValidDomain(email)) {
            throw { code: 'auth/invalid-domain', message: `Apenas emails do domínio @${ALLOWED_DOMAIN} são permitidos.` };
        }
